...
template <class T>
DoublyLinkedList<T> createList(int quantity, T upperLimit, char type)
{ 
...
int main() {
    ...
    // list.print();
    // try {
    //     list.updateAt(list.findData("Tenedor"),"UpdateAt");
    // } catch (out_of_range& e) {
    //     cout << e.what() << endl;
    // }
    ...
    // cout<<list.getData(list.findData("Sarten"))<<endl;


    // cout<<"[] =\n";
    // list[0] = "Platón";
    // list.print();
    // list.deleteData("Carro");
    // list.print();
    // list.deleteData("Sarten");
    // list.print();
    // list.deleteAt(0);
    // list.print();
...
while (input) {
    ...
    cout<<"12. Ordenar lista con Shell sort\n13. Duplicar la Lista\n14. Remover elementos duplicados\n0. Salir\n";
    cin>>input;

    while (input != 1 && input != 2 && input != 3 && input != 4 && input != 5 && input != 6 && input != 7 && input != 8 && input != 9 && input != 10 && input != 11 && input != 12 && input != 13 && input != 14 && input != 0) {
        printf("\nOpcion no valida\n");
        cout<<"\n¿Qué desea hacer con la lista?\n";
        cout<<"1. Agregar un elemento al principio de la lista\n2. Agregar un elemento al final de la lista\n3. Insertar un elemento a la derecha de un índice dado\n4. Borrar un elemento dado de la lista\n";
        cout<<"9. Encuentra un elemento en la lista\n10. Iguala una lista con los datos de otra lista\n11. Limpiar Lista\n";
    ...
    if (input == 1) {
        ...
        if (tipoLista == 1)  {
            ...
            cout<<"El elemento en esa posición es: "<<listD[indice]<<endl;
        }
    } else if (input == 7) {
        ...
        if(tipoLista == 2) {
            DoublyLinkedList<double> listaD2;
            double elInput = 0;
            while (elInput >= 0) {
                cin>>elInput;
        ...
        if(tipoLista == 1) {
            listI.clear();
            // listI.print();
            listI = createList(1,1,'i');
            input = 1;
        }
        if(tipoLista == 2) {
            listD.clear();
            // listD.print();
            listD = createList(1,1.0,'d');
            input = 1;
        }
        
    } else if (input == 12)  {
        cout<<"Lista ordenada con Shell Sort\n";
        if(tipoLista == 1) {
            listI.sort();
            listI.print();
        }
        ...
        cout<<"Elementos duplicados removidos\n";
        if(tipoLista == 1) {
