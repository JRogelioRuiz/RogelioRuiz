...
/*Método de la clase Queue que recibe un dato template y lo ingresa al final de la fila*/
template<class T> 
...
/*Método de la clase Queue sin parámetros que elimina el primer elemento de la fila*/
template<class T>
T Queue<T>::pop() {
    if (!isEmpty()) {
...
/*Método de la clase Queue sin parámetros que regresa el valor de el primer elemento de la fila*/
template<class T>
T Queue<T>::getFront() {
    if (!isEmpty()) {
...
/*Método de la clase Queue sin parámetros que regresa verdadero si la fila está vacía y falso si no*/
template<class T>
bool Queue<T>::isEmpty() {
    return size == 0;
} 

/*Método de la clase Queue sin parámetros que despliega en orden los elementos de la fila*/
template<class T> 
void Queue<T>::print() { 
