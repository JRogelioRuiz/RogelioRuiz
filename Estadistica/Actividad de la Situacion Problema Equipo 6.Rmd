...
Susana Leija: 33%
Jorge Vincenzo: 33%
$\underline{José}$ $\underline{Rogelio}$ $\underline{Ruiz}$: 33%

Fecha de Entrega: 04 de febrero de 2023
...
# Guardando la nueva BD dela muestra: 
...
summary(regresion5)
```
yc1 = 37.682 - 21.572*x5 - 1.286*x5^2 
...
summary(regresion6)
```
y6 = 39.5488 - 0.8034*x7 + 0.00284*x7^2 
...
summary(regresion7)
```
y7 = 56.36 - 1.4646*x9 + 0.012009*x9^2 
...
summary(regresion8)
```
y8 = 50.6705 - 0.638589*x11 + 0.001737*x11^2 
...
```{r}
plot(x5, y5, main = "Regresión Cúbica entre O3 y CO", xlab = "CO", ylab = "O3", col = "red")
z1 = seq(0,2.5, 0.01)
prediccion_c1 = 35.239 + 12.920*z1 - 59.307*z1^2 + 21.938*z1^3  
lines(z1,prediccion_c1)
text(2,30, "y = 35.239 + 12.920*xx1 - 59.307*xx1^2 + 21.938*xx1^3")
```
...
```
y = 4.646e+01 -1.621e+00*xx4 + 1.379e-02*xx1^2 -3.274e-05*xx1^3 
...
```{r}
plot(x7, y6, main = "Regresión Cúbica entre O3 y NO", xlab = "NO", ylab = "O3", col = "red")
z2 = seq(0,300, 0.01)
...
```{r}
plot(x9, y7, main = "Regresión Cúbica entre O3 y NO2", xlab = "NO2", ylab = "O3", col = "red")
z3 = seq(0,100, 0.01)
...
```{r}
plot(x11, y8, main = "Regresión Cúbica entre O3 y NOX", xlab = "NOX", ylab = "O3", col = "red")
z4 = seq(0,300, 0.01)
...
```{r}
plot(x11, y8, main = "Regresión Múltiple entre O3, CO, NO, NO2 y NOX", xlab = "variables independientes", ylab = "O3", col = "red")
z5 = seq(0,300, 0.01)
